...
var disqus_shortname = mainConfig.disqus_shortname;
...
$('#discuss').on('click', function () {
    ...
    dsq.async = true;
    dsq.src = '//' + mainConfig.disqus_shortname + '.disqus.com/embed.js';
...
ga('create', mainConfig.google_analytics_tracking_id, 'auto');
ga('send', 'pageview');
